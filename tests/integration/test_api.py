...
class TestCustomerServiceEndpoint:
    ...
    def test_basic_request(self):
        ...
        response = client.post(
            "/api/v1/customer-service", json={"query": "耳机能退货吗？", "domain": "ecommerce"}
        )
    ...
    def test_invalid_domain(self):
        ...
        response = client.post(
            "/api/v1/customer-service", json={"query": "测试", "domain": "invalid"}
        )
    ...
    def test_pii_masking_in_logs(self):
        ...
        response = client.post(
            ...
            json={"query": "我的手机号13812345678可以退货吗？", "domain": "ecommerce"},
        )
...
class TestFinanceRAGEndpoint:
    ...
    def test_basic_request(self):
        ...
        response = client.post(
            "/api/v1/finance-rag",
            json={"query": "某公司2023年的净利润是多少？", "domain": "finance"},
        )
